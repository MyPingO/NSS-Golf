...
class ShotUploadForm(FlaskForm):
    ...
    wind_direction = SelectField('Wind Direction', choices=[('North','North'),('South','South'),('East','East'),('West','West'),('North-East','North-East'),('North-West','North-West'),('South-East','South-East'),('South-West','South-West'),('None','None')], validators=[DataRequired()])
...
class ShotSearchForm(FlaskForm):
    ...
    wind_direction = SelectField('Wind Direction', choices=[('','Select...'),('North','North'),('South','South'),('East','East'),('West','West'),('North-East','North-East'),('North-West','North-West'),('South-East','South-East'),('South-West','South-West'),('None','None')], validators=[Optional()])
...
class EditImageForm(FlaskForm):
    ...
    wind_speed = IntegerField('Wind Speed', validators=[InputRequired(), NumberRange(min=0, max=54)])
    wind_direction = SelectField('Wind Direction', choices=[('North','North'),('South','South'),('East','East'),('West','West'),('North-East','North-East'),('North-West','North-West'),('South-East','South-East'),('South-West','South-West'),('None','None')])
